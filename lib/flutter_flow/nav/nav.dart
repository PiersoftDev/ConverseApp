      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'site_user_edit_profile_page',
              path: 'siteUserEditProfilePage',
              builder: (context, params) => SiteUserEditProfilePageWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'gatepass_page',
              path: 'gatepassPage',
              builder: (context, params) => GatepassPageWidget(),
            )
