...
import 'vendor_login_page_model.dart';
export 'vendor_login_page_model.dart';

class VendorLoginPageWidget extends StatefulWidget {
  const VendorLoginPageWidget({Key? key}) : super(key: key);

  @override
  _VendorLoginPageWidgetState createState() => _VendorLoginPageWidgetState();
}

class _VendorLoginPageWidgetState extends State<VendorLoginPageWidget> {
  late VendorLoginPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VendorLoginPageModel());

    _model.loginEmailAddressController = TextEditingController();
    _model.loginPasswordController = TextEditingController();
    _model.createAccountGSTController = TextEditingController();
    _model.createAccountAadharNumberController = TextEditingController();
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: TextFormField(
                                            ...
                                            validator: _model
                                                .createAccountGSTControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                        Padding(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .createAccountAadharNumberController,
                                            obscureText: false,
                                            decoration: InputDecoration(
